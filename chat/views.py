...
#     return render(request, 'user_creation_view.html', context=context)
...
#     return render(request, 'user_update_view.html', context=context)
...
#     return render(request, 'room_creation_view.html', context=context)

# @login_required
def prepare_chat_view(request):
    context = {}

    return render(request, 'prepare_chat_view.html', context=context)
...
def join_chat_view(request, room_code):
    ...
    return render(request, 'join_chat_view.html', context=context)
...
def select_room_view(request):
    ...
    if room_code == None:
        ...
        return render(request, 'select_room_view.html', context=context)
    ...
    return render(request, 'select_room_view.html', context)
